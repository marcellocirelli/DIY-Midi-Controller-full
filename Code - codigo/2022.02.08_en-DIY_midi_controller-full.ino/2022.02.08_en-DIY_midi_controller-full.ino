...
const byte N_ENCODERS = 4; //* number of encoders
...
byte ENCODER_CC_N[N_ENCODERS] = {15, 16, 17, 18}; // Add the CC NUMBER of each encoder you want

Encoder encoder[N_ENCODERS] = {{5, 4}, {7, 6}, {9, 8}, {15, 14}}; // the two pins of each encoder -  Use pins with Interrupts!
